...
public class PlayHistoryAdapter extends BaseAdapter {
    ...
    public PlayHistoryAdapter(Context mContext, JsonArray data, int status, String username, int userId) {
...
//        Log.i("username",username+"");
        ...
        if (convertView==null){
            vh = new ViewHolder();
            convertView= LayoutInflater.from(mContext).inflate(R.layout.play_history_item,parent,false);
            ...
            vh.deleteIcon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    OkHttpUtils.sendOkHttp(false, "playHistory/removePlayHistory", jsonObject, new Callback() {
                        @Override
